...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void initModule() {
        try {
            ...
            Log.e("UHF_ERROR", "Native library loading failed - device architecture not supported", e);
            Toast.makeText(this, "UHF module not supported on this device architecture", Toast.LENGTH_LONG).show();
            isConnectUHF = false;
        } catch (Exception e) {
            Log.e("UHF_ERROR", "UHF module initialization failed", e);
            Toast.makeText(this, getString(R.string.module_init_fail), Toast.LENGTH_SHORT).show();
            isConnectUHF = false;
        }
